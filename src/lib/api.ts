...
export const bulkUpdateReadStatus = async ({ contactIds, status }: BulkUpdateStatusParams) => {
  const { data, error } = await supabase.functions.invoke('bulk-update-read-status', {
    body: {
